...
var Marker = (function() {
  ...
  var api,
      ...
      ARRAY_SLICE = [].slice,
      TAGS = [
  			'p','h1','h2','h3','h4','h5','h6','strong','em','i','b','abbr','address','bdo','blockquote','cite','q','code','ins','del','dfn','kbd','pre','samp','var','br',
  			'div', 'span', 'section', 'header', 'footer', 'sidebar', 'sub', 'sup', 'nav',
  			'a', 'base',
    ...
    _pop: function() {
      var last = this.elements.pop();
		...
		_render: function() {
			...
			while (this.fns.length === 1 && this.elements.length) this.end();
			return this.storage;
		}
  };
